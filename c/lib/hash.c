...
static inline libfilter_u64x2 libfilter_hash_plus32(libfilter_u64x2 a,
                                                    libfilter_u64x2 b) {
...
static inline libfilter_u64x2 libfilter_hash_mix(libfilter_u64x2 accum,
                                                 libfilter_u64x2 input,
...
static inline void libfilter_hash_ehc_load(
    const char input[7 * 3 * sizeof(libfilter_u64x2)], libfilter_u64x2 output[7][3]) {
...
static inline void libfilter_hash_greedy_input(libfilter_hash_accum* here,
                                               libfilter_u64x2 x) {
  for (unsigned i = 0; i < 3; ++i) {
...
static inline void libfilter_hash_greedy(const libfilter_hash_accum* here,
                                         uint64_t output[3]) {
  for (unsigned i = 0; i < 3; ++i) {
