...
JNIEXPORT
jboolean JNICALL Java_libfilter_Library_Allocate(JNIEnv* a, jobject obj, jobject bb, jint bytes) {
...
JNIEXPORT jboolean JNICALL Java_libfilter_Library_FindDetail(JNIEnv* a, jobject obj, jobject bb,
                                                   jlong hashval) {
  // return false;
...
JNIEXPORT void JNICALL Java_libfilter_Library_AddDetail(JNIEnv* a, jobject obj, jobject bb,
                                              jlong hashval) {
  libfilter_block* me = (*a)->GetDirectBufferAddress(a, bb);
  libfilter_block_add_hash(hashval, me);
}

JNIEXPORT jboolean JNICALL Java_libfilter_Library_Deallocate
