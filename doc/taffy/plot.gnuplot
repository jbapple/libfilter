...
plot '< grep fpp all-bench-100000000-017.txt | grep MinTaffy    | sort -n -t , -k 3' using 3:(8*$4/$3) with lines lw 9 title "MSCF", \
     "< grep fpp all-bench-100000000-017.txt | grep TaffyCuckoo | sort -n -t , -k 3" using 3:(8*$4/$3) with linespoints title "SCF", \
     "< grep fpp all-bench-100000000-017.txt | grep TaffyBlock  | sort -n -t , -k 3" using 3:(8*$4/$3) with lines title "SBF", \
...
plot '< grep fpp all-bench-100000000-017.txt | grep MinTaffy    | sort -n -t , -k 3' using 3:(100*$6) with lines lw 9 title "MSCF", \
     "< grep fpp all-bench-100000000-017.txt | grep TaffyCuckoo | sort -n -t , -k 3" using 3:(100*$6) with linespoints title "SCF", \
     "< grep fpp all-bench-100000000-017.txt | grep TaffyBlock  | sort -n -t , -k 3" using 3:(100*$6) with lines title "SBF", \
...
plot "< grep fpp all-bench-100000000-017.txt | grep MinTaffy    | sort -n -t , -k 3" using 3:4 with lines lw 9 title "MSCF", \
     "< grep fpp all-bench-100000000-017.txt | grep TaffyCuckoo | sort -n -t , -k 3" using 3:4 with linespoints title "SCF", \
     "< grep fpp all-bench-100000000-017.txt | grep TaffyBlock  | sort -n -t , -k 3" using 3:4 with lines title "SBF", \
...
# unset format;
# plot "< grep insert m6g.medium.txt | grep MinTaffy    | sort -n -t , -k 3" using 3:6 with lines lw 1 title "MSCF", \
#      "< grep insert m6g.medium.txt | grep TaffyCuckoo | sort -n -t , -k 3" using 3:6 with lines lw 1 title "SCF", \
