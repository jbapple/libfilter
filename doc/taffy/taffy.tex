...
For inserts, TBFs are the fastest of the three taffy filter variants; they are even faster than the fastest no-taffy variant, split block Bloom filters.
TBFs are faster than the other cuckoo filters because is it simple, branch-free, and induces a single cache miss; they are faster than the pre-sized split block Bloom filter because, while being built, the entirety of the filter fits in cache until about 10 million elements have been inserted.
