...
We showed that these data structures can perform well at scale under both synthetic and real-world benchmarks and have potential for multiple applications in databases and security, and we identified decision points for a practitioner to decide when to use which structure.
