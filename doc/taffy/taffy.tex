...
%% Section~\ref{applications} describes applications of taffy filters.
Section~\ref{eval} describes experimental performance results on all three taffy filters. %\footnote{Experiments can be replicated with \url{https://github.com/jbapple/libfilter}}
...
In cuckoo filters, this raises the occupancy limit from 50\% to over 90\%.
