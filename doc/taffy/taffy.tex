...
\hline {\bf insert (ns/key)} & 25 & 558 & \TCF{} + 2.2 & 113\\
\hline {\bf fpp} & 0.25\% & 0.26\% & 0.71\% & 0\%\\
\hline {\bf lookup (ns/key)} & 301 & 111 & 74 & 5347\\
...
For the ``Raw'' column, we consider only the cost of storing the last 64 bits in each hash in a single sorted array with binary search as the lookup method.
