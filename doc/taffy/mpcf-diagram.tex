...
\draw (2, -7.25) node[left] {fingerprint};
\draw (2, -7.25) node[right] {tail};
\draw (0, -7) rectangle (2.75, -7.5);
\draw (2, -7) -- (2, -7.5);
\draw[dashed] (1.25, -5.5) -- (0, -7);
\draw[dashed] (1.75, -5.5) -- (2.75, -7);
\draw[dashed, rounded corners=10] (-0.25,-6.75) rectangle (3,-7.75);
\draw (3, -7.25) node[right] {entry};

\draw (1.625, -8.125) node[left] {$\mathbb{Z}_2^8$ or $\mathbb{Z}_2^9$};
\draw (2.25, -8.125) node[right] {$\mathbb{Z}_2^0$ or $\mathbb{Z}_2^1$ or $\mathbb{Z}_2^2$ or $\mathbb{Z}_2^3$ or $\mathbb{Z}_2^4$ or $\mathbb{Z}_2^5$};
