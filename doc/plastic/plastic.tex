...
\usepackage{color}
\usepackage{graphicx}
%\PassOptionsToPackage{hyphens}{url}\usepackage[pdftitle={Stretching your data with taffy filters}]{hyperref}
...
% TODO: be more careful about Z sub 2 sup k and Z sub (2 sup k)
...
%%  LocalWords:  UpsizeMTCF TBFs Structs structs SMT
