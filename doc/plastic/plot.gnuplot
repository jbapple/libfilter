...
plot '< grep fpp incremental-0.001-stashes-8-003.txt | grep   Min | sort -n -t , -k 3' using 3:(100 - 100/(8*($4/$3)/-(log($6)/log(2)))) with lines lw 9 title "MPCF", \
     "< grep fpp incremental-0.001-stashes-8-003.txt | grep \\\"E | sort -n -t , -k 3" using 3:(100 - 100/(8*($4/$3)/-(log($6)/log(2)))) with linespoints title "PCF", \
...
unset format y;
plot "< grep insert incremental-0.001-stashes-8-003.txt | grep   Min | sort -n -t , -k 3" using 3:6 with linespoints title "MPCF", \
...
plot "< grep find_missing incremental-0.001-stashes-8-003.txt | grep   Min | sort -n -t , -k 3" using 3:6 with lines lw 9 title "MPCF", \
     "< grep find_missing incremental-0.001-stashes-8-003.txt | grep \\\"E | sort -n -t , -k 3" using 3:6 with linespoints title "PCF", \
...
plot "< grep find_present incremental-0.001-stashes-8-003.txt | grep   Min | sort -n -t , -k 3" using 3:6 with lines lw 9 title "MPCF", \
     "< grep find_present incremental-0.001-stashes-8-003.txt | grep \\\"E | sort -n -t , -k 3" using 3:6 with linespoints title "PCF", \
...
plot "< grep fpp incremental-0.001-stashes-8-if-80p-002.txt | grep   Min | sort -n -t , -k 3" using 3:4 with lines lw 9 title "MPCF", \
     "< grep fpp incremental-0.001-stashes-8-if-80p-002.txt | grep \\\"E | sort -n -t , -k 3" using 3:4 with linespoints title "PCF", \
     "< grep fpp incremental-0.001-stashes-8-if-80p-002.txt | grep \\\"B | sort -n -t , -k 3" using 3:4 with lines title "PBF"
